...
COMMON = {"G1_META2": "2", "G1_M2_CFG": "config_meta2_g1payload.json",
          "G1_SIM_ID": "lab_v1_nzab", "G1_SIM_NOISE": "1", "G1_M2_L3": "1", "G1_M2_L4": "1",
          "G1_M2_PROFILES": "1", "G1_M2_DOORLIB": "1", "G1_M2_FRAGSPEED": "1",
          "G1_M2_ABORT_WIN": "150", "G1_M2_ABORT_PROG": "0.25", "G1_M2_HELP_S": "16"}
ARMS = {
    "off": {"G1_METASM": "0", "G1_RETREAT": "0", "G1_M2_STATE": "meta2_state_nzab_off.json"},
    "on":  {"G1_METASM": "1", "G1_RETREAT": "1", "G1_M2_STATE": "meta2_state_nzab_on.json"},
    "hum": {"G1_METASM": "1", "G1_RETREAT": "1", "G1_M2_STATE": "meta2_state_nzab_on.json"},
}
...
for i, arm in enumerate(ORDER):
    ...
    logpath = os.path.join(SCRATCH, "nzab_%02d_%s.log" % (i, arm))
    before = newest_run()
...
json.dump(results, open(os.path.join(SCRATCH, "nzab_results.json"), "w"), indent=1)
